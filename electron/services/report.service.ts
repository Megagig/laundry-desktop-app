...
export class ReportService {
  ...
  async getWeeklyRevenue(startDate: string, endDate: string): Promise<RevenueReport[]> {
    ...
    const grouped = new Map<string, RevenueReport>()
  ...
  async getPopularServices(startDate: string, endDate: string, limit: number = 10) {
